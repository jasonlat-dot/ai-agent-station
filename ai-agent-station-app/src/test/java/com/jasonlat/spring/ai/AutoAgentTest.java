...
import com.jasonlat.spring.ai.advisors.RagAnswerAdvisor;
...
//                .build();
    ...
    public void test_dynamic_multi_step_execution() {
        ...
        String userInput  = "搜索 springboot 相关知识，生成4个主要内容章节。每个章节要包括课程内容和配套示例代码。并发对应章节创建对md文档，方便小白伙伴学习。文档位置：E:\\project\\KnowledegPlanet\\ai-agent-station\\ai-agent-station\\ai-agent-station-app";
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("C:\\Users\\Administrator\\AppData\\Roaming\\npm\\npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "E:\\project\\KnowledegPlanet\\ai-agent-station\\ai-agent-station\\ai-agent-station-app", "E:\\project\\KnowledegPlanet\\ai-agent-station\\ai-agent-station\\ai-agent-station-app")
                .build();
