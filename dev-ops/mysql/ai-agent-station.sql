...
INSERT INTO `ai_agent_flow_config` (`agent_id`, `client_id`, `client_name`, `client_type`, `sequence`)
VALUES
('1','3001','通用的','DEFAULT',1),
('3','3101','任务分析和状态判断','TASK_ANALYZER_CLIENT',1),
('3','3102','具体任务执行','PRECISION_EXECUTOR_CLIENT',2),
('3','3103','质量检查和优化','QUALITY_SUPERVISOR_CLIENT',3);
...
CREATE TABLE `ai_client_model` (
    ...
    UNIQUE KEY `uk_model_name_api_id` (`model_name`, `api_id`),
