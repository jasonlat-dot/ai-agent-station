...
INSERT INTO `data_keys` (data_keys.`name`, data_keys.`active`, data_keys.`scope`, data_keys.`provider`, data_keys.`encrypted_data`, data_keys.`created`, data_keys.`updated`, data_keys.`label`)
VALUES
...
VALUES
	(1,0,'ngmigration','migrated','true','2023-10-28 04:06:55','2023-10-28 04:06:58'),
	(2,1,'ngmigration','stateKey','{\"orgId\":1,\"createdFolders\":[]}','2023-10-28 04:06:57','2023-10-28 04:06:57'),
...
VALUES
	...
	(3,'add unique index login','CREATE UNIQUE INDEX `UQE_user_login` ON `user` (`login`);',1,'','2023-10-28 04:02:28'),
	(4,'add unique index email','CREATE UNIQUE INDEX `UQE_user_email` ON `user` (`email`);',1,'','2023-10-28 04:02:28'),
	...
	(18,'Add index login/email','CREATE INDEX `IDX_user_login_email` ON `user` (`login`,`email`);',1,'','2023-10-28 04:02:28'),
	...
	(41,'add unique index user_id_dashboard_id','CREATE UNIQUE INDEX `UQE_star_user_id_dashboard_id` ON `star` (`user_id`,`dashboard_id`);',1,'','2023-10-28 04:02:29'),
	...
	(52,'add index account_id','CREATE INDEX `IDX_dashboard_account_id` ON `dashboard` (`account_id`);',1,'','2023-10-28 04:02:29'),
	...
	(55,'add unique index dasboard_id_term','CREATE UNIQUE INDEX `UQE_dashboard_tag_dashboard_id_term` ON `dashboard_tag` (`dashboard_id`,`term`);',1,'','2023-10-28 04:02:29'),
	...
	(63,'alter data to mediumtext v1','ALTER TABLE dashboard MODIFY data MEDIUMTEXT;',1,'','2023-10-28 04:02:30'),
	...
	(96,'add index account_id','CREATE INDEX `IDX_data_source_account_id` ON `data_source` (`account_id`);',1,'','2023-10-28 04:02:31'),
	(97,'add unique index account_id_name','CREATE UNIQUE INDEX `UQE_data_source_account_id_name` ON `data_source` (`account_id`,`name`);',1,'','2023-10-28 04:02:31'),
	...
	(117,'add index account_id','CREATE INDEX `IDX_api_key_account_id` ON `api_key` (`account_id`);',1,'','2023-10-28 04:02:31'),
	(118,'add index key','CREATE UNIQUE INDEX `UQE_api_key_key` ON `api_key` (`key`);',1,'','2023-10-28 04:02:31'),
	(119,'add index account_id_name','CREATE UNIQUE INDEX `UQE_api_key_account_id_name` ON `api_key` (`account_id`,`name`);',1,'','2023-10-28 04:02:31'),
	...
	(170,'Add column json_data','alter table `preferences` ADD COLUMN `json_data` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL ',1,'','2023-10-28 04:02:33'),
	(171,'alter json_data to mediumtext v1','ALTER TABLE preferences MODIFY json_data MEDIUMTEXT;',1,'','2023-10-28 04:02:33'),
	...
	(179,'Add unique index alert_id_tag_id','CREATE UNIQUE INDEX `UQE_alert_rule_tag_alert_id_tag_id` ON `alert_rule_tag` (`alert_id`,`tag_id`);',1,'','2023-10-28 04:02:33'),
	...
	(183,'create index UQE_alert_rule_tag_alert_id_tag_id - Add unique index alert_id_tag_id V2','CREATE UNIQUE INDEX `UQE_alert_rule_tag_alert_id_tag_id` ON `alert_rule_tag` (`alert_id`,`tag_id`);',1,'','2023-10-28 04:02:33'),
	...
	(205,'alter settings to mediumtext','ALTER TABLE alert MODIFY settings MEDIUMTEXT;',1,'','2023-10-28 04:02:34'),
	...
	(220,'Add unique index annotation_id_tag_id','CREATE UNIQUE INDEX `UQE_annotation_tag_annotation_id_tag_id` ON `annotation_tag` (`annotation_id`,`tag_id`);',1,'','2023-10-28 04:02:34'),
	...
	(224,'create index UQE_annotation_tag_annotation_id_tag_id - Add unique index annotation_id_tag_id V3','CREATE UNIQUE INDEX `UQE_annotation_tag_annotation_id_tag_id` ON `annotation_tag` (`annotation_id`,`tag_id`);',1,'','2023-10-28 04:02:34'),
	...
	(246,'add index dashboard_id','CREATE INDEX `IDX_dashboard_version_dashboard_id` ON `dashboard_version` (`dashboard_id`);',1,'','2023-10-28 04:02:35'),
	(247,'add unique index dashboard_id and version','CREATE UNIQUE INDEX `UQE_dashboard_version_dashboard_id_version` ON `dashboard_version` (`dashboard_id`,`version`);',1,'','2023-10-28 04:02:35'),
	(248,'Set dashboard version to 1 where 0','UPDATE dashboard SET version = 1 WHERE version = 0',1,'','2023-10-28 04:02:35'),
	(249,'save existing dashboard data in dashboard_version table v1','INSERT INTO dashboard_version\n(\n	dashboard_id,\n	version,\n	parent_version,\n	restored_from,\n	created,\n	created_by,\n	message,\n	data\n)\nSELECT\n	id,\n	version,\n	version,\n	version,\n	updated,\n	COALESCE(updated_by, -1),\n	\'\',\n	data\nFROM dashboard;',1,'','2023-10-28 04:02:35'),
	(250,'alter data to mediumtext v1','ALTER TABLE dashboard_version MODIFY data MEDIUMTEXT;',1,'','2023-10-28 04:02:35'),
	(251,'create team table','CREATE TABLE IF NOT EXISTS `team` (\n`id` BIGINT(20) PRIMARY KEY AUTO_INCREMENT NOT NULL\n, `name` VARCHAR(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL\n, `org_id` BIGINT(20) NOT NULL\n, `created` DATETIME NOT NULL\n, `updated` DATETIME NOT NULL\n) ENGINE=InnoDB DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci;',1,'','2023-10-28 04:02:35'),
	(252,'add index org_id','CREATE INDEX `IDX_team_org_id` ON `team` (`org_id`);',1,'','2023-10-28 04:02:35'),
	...
	(258,'add index org_id','CREATE INDEX `IDX_team_member_org_id` ON `team_member` (`org_id`);',1,'','2023-10-28 04:02:35'),
	...
	(260,'add index team_id','CREATE INDEX `IDX_team_member_team_id` ON `team_member` (`team_id`);',1,'','2023-10-28 04:02:35'),
	...
	(277,'add index username','CREATE INDEX `IDX_login_attempt_username` ON `login_attempt` (`username`);',1,'','2023-10-28 04:02:36'),
	...
	(286,'alter auth_id to length 190','ALTER TABLE user_auth MODIFY auth_id VARCHAR(190);',1,'','2023-10-28 04:02:36'),
	...
	(294,'add index operation_uid','CREATE UNIQUE INDEX `UQE_server_lock_operation_uid` ON `server_lock` (`operation_uid`);',1,'','2023-10-28 04:02:36'),
	...
	(296,'add unique index auth_token','CREATE UNIQUE INDEX `UQE_user_auth_token_auth_token` ON `user_auth_token` (`auth_token`);',1,'','2023-10-28 04:02:36'),
	(297,'add unique index prev_auth_token','CREATE UNIQUE INDEX `UQE_user_auth_token_prev_auth_token` ON `user_auth_token` (`prev_auth_token`);',1,'','2023-10-28 04:02:36'),
	(298,'add index user_id','CREATE INDEX `IDX_user_auth_token_user_id` ON `user_auth_token` (`user_id`);',1,'','2023-10-28 04:02:36'),
	...
	(300,'add index revoked_at','CREATE INDEX `IDX_user_auth_token_revoked_at` ON `user_auth_token` (`revoked_at`);',1,'','2023-10-28 04:02:37'),
	...
	(302,'add unique index cache_key','CREATE UNIQUE INDEX `UQE_cache_data_cache_key` ON `cache_data` (`cache_key`);',1,'','2023-10-28 04:02:37'),
	(303,'create short_url table v1','CREATE TABLE IF NOT EXISTS `short_url` (\n`id` BIGINT(20) PRIMARY KEY AUTO_INCREMENT NOT NULL\n, `org_id` BIGINT(20) NOT NULL\n, `uid` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL\n, `path` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL\n, `created_by` INT NOT NULL\n, `created_at` INT NOT NULL\n, `last_seen_at` INT NULL\n) ENGINE=InnoDB DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci;',1,'','2023-10-28 04:02:37'),
	(304,'add index org_id-uid','CREATE UNIQUE INDEX `UQE_short_url_org_id_uid` ON `short_url` (`org_id`,`uid`);',1,'','2023-10-28 04:02:37'),
	...
	(396,'add index org_id-namespace-key','CREATE UNIQUE INDEX `UQE_kv_store_org_id_namespace_key` ON `kv_store` (`org_id`,`namespace`,`key`);',1,'','2023-10-28 04:02:40'),
	...
	(399,'add unique index role_id','CREATE INDEX `IDX_permission_role_id` ON `permission` (`role_id`);',1,'','2023-10-28 04:02:40'),
	...
	(404,'add index org_id','CREATE INDEX `IDX_role_org_id` ON `role` (`org_id`);',1,'','2023-10-28 04:02:40'),
	...
	(408,'add index team_org_id','CREATE INDEX `IDX_team_role_org_id` ON `team_role` (`org_id`);',1,'','2023-10-28 04:02:40'),
	...
	(410,'add index team_team_id','CREATE INDEX `IDX_team_role_team_id` ON `team_role` (`team_id`);',1,'','2023-10-28 04:02:40'),
	(411,'create user role table','CREATE TABLE IF NOT EXISTS `user_role` (\n`id` BIGINT(20) PRIMARY KEY AUTO_INCREMENT NOT NULL\n, `org_id` BIGINT(20) NOT NULL\n, `user_id` BIGINT(20) NOT NULL\n, `role_id` BIGINT(20) NOT NULL\n, `created` DATETIME NOT NULL\n) ENGINE=InnoDB DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci;',1,'','2023-10-28 04:02:40'),
	(412,'add index user_org_id','CREATE INDEX `IDX_user_role_org_id` ON `user_role` (`org_id`);',1,'','2023-10-28 04:02:40'),
	...
	(414,'add index user_user_id','CREATE INDEX `IDX_user_role_user_id` ON `user_role` (`user_id`);',1,'','2023-10-28 04:02:40'),
	(415,'create builtin role table','CREATE TABLE IF NOT EXISTS `builtin_role` (\n`id` BIGINT(20) PRIMARY KEY AUTO_INCREMENT NOT NULL\n, `role` VARCHAR(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL\n, `role_id` BIGINT(20) NOT NULL\n, `created` DATETIME NOT NULL\n, `updated` DATETIME NOT NULL\n) ENGINE=InnoDB DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci;',1,'','2023-10-28 04:02:40'),
	(416,'add index role_id','CREATE INDEX `IDX_builtin_role_role_id` ON `builtin_role` (`role_id`);',1,'','2023-10-28 04:02:40'),
	(417,'add index name','CREATE INDEX `IDX_builtin_role_role` ON `builtin_role` (`role`);',1,'','2023-10-28 04:02:40'),
	...
	(419,'add index org_id','CREATE INDEX `IDX_builtin_role_org_id` ON `builtin_role` (`org_id`);',1,'','2023-10-28 04:02:40'),
	...
	(422,'add unique index uid','CREATE UNIQUE INDEX `UQE_role_uid` ON `role` (`uid`);',1,'','2023-10-28 04:02:40'),
	...
	(431,'add index org_id-created_by-datasource_uid','CREATE INDEX `IDX_query_history_org_id_created_by_datasource_uid` ON `query_history` (`org_id`,`created_by`,`datasource_uid`);',1,'','2023-10-28 04:02:41'),
	...
	(440,'add index user_id-query_uid','CREATE UNIQUE INDEX `UQE_query_history_star_user_id_query_uid` ON `query_history_star` (`user_id`,`query_uid`);',1,'','2023-10-28 04:02:41'),
	...
	(506,'Add unique index for uid and org_id','CREATE UNIQUE INDEX `UQE_folder_uid_org_id` ON `folder` (`uid`,`org_id`);',1,'','2023-10-28 04:02:43'),
	...
	(508,'Add unique index for title and parent_uid','CREATE UNIQUE INDEX `UQE_folder_title_parent_uid` ON `folder` (`title`,`parent_uid`);',1,'','2023-10-28 04:02:43'),
	(509,'Remove unique index for title and parent_uid','DROP INDEX `UQE_folder_title_parent_uid` ON `folder`',1,'','2023-10-28 04:02:43'),
	...
	(512,'add unique index device_id','CREATE UNIQUE INDEX `UQE_anon_device_device_id` ON `anon_device` (`device_id`);',1,'','2023-10-28 04:02:43'),
	(513,'add index updated_at','CREATE INDEX `IDX_anon_device_updated_at` ON `anon_device` (`updated_at`);',1,'','2023-10-28 04:02:43'),
	...
	(515,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:43'),
	(516,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:44'),
	(517,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:45'),
	(518,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:47'),
	(519,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:48'),
	(520,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:51'),
	(521,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:02:55'),
	(522,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:03:02'),
	(523,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:03:16'),
	(524,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:03:42'),
	(525,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:24'),
	(526,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:25'),
	(527,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:27'),
	(528,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:28'),
	(529,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:30'),
	(530,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:32'),
	(531,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:36'),
	(532,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:44'),
	(533,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:04:57'),
	(534,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:05:23'),
	(535,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:23'),
	(536,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:24'),
	(537,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:25'),
	(538,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:26'),
	(539,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:28'),
	(540,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:30'),
	(541,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:34'),
	(542,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',0,'Error 1071 (42000): Specified key was too long; max key length is 767 bytes','2023-10-28 04:06:41'),
	(543,'add unique index key_id','CREATE UNIQUE INDEX `UQE_signing_key_key_id` ON `signing_key` (`key_id`);',1,'','2023-10-28 04:06:55'),
...
VALUES
	(1,0,'Main ','','','','','','',NULL,'2023-10-28 04:06:55','2023-10-28 04:06:55');
